...
describe('TasksService', () => {
  ...
  it('requires project management access and project membership for an assignee', async () => {
    ...
    mockPrisma.task.create.mockResolvedValue({ id: 10, projectId: 4 });

    await service.create(
      { title: 'Build board', projectId: 4, assignedToId: 3 },
      manager,
    );
    ...
    expect(mockRealtime.emitTaskEvent).toHaveBeenCalledWith(
      4,
      'task.created',
      10,
      manager.sub,
